    ...
    <div className="max-w-2xl mx-auto px-6 py-10">
      ...
      {loading ? (
        ...
        <div className="card p-8">
          <h2 className="text-lg font-bold text-slate-800 mb-2">{t("Billing not configured")}</h2>
        ...
        <div className="space-y-6">
          ...
          {/* Actions */}
          <div className="card p-8">
            <h2 className="text-base font-bold text-slate-800 mb-1">{t("Pro")}</h2>
            <p className="text-sm text-slate-500 mb-5">
              {t("Unlimited sourcing events, multi-wave discovery, and live outreach.")}
            </p>
